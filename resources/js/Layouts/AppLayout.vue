                            ...
                            >
                                ...
                                <NavLink
                                    ...
                                    :active="
                                        ...
                                        route().current('inventory.show') ||
                                        route().current('inventory.create') ||
                                        route().current('inventory.edit') ||
                                ...
                                <NavLink
                                    :href="route('entries')"
                                    :active="
                                        route().current('entries') ||
                                        route().current('entries.show') ||
                                        route().current('entries.create') ||
                                        route().current('entries.edit')
                                    "
                                >
                                    Entradas
                                </NavLink>
